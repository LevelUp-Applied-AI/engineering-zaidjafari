...
Cohort **2024A** has the highest average score (81.8). This might suggest that students in this cohort had a stronger technical background or more preparation time compared to the 2025A cohort.
...
There are **8** students who scored 80 or above. It is interesting to see a diverse representation from Jordan, Palestine, and Egypt among the top scorers, showing high performance across different regions.
...
**Lina Barakat** shows a very consistent and high-performance pattern; she submitted all three projects on time with excellent grades (98, 95, 96). This indicates a highly committed and technically proficient learner.